...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <h1>Action Required: Sign Your Contract</h1>

            <p>Thank you for choosing <strong>MyEnergy</strong>! We're excited to help you move forward with your order.</p>

            <p>To get started, we have prepared your contract for electronic signature. Please click the button below to review and sign your document securely online.</p>

            <div class="btn-wrapper">
                <a href="{{ $signingUrl }}" class="button">Review & Sign Contract</a>
            </div>

            <p>Once signed, a completed copy will be automatically sent to you for your records. If you have any questions about the details of your agreement, please don't hesitate to reach out.</p>

            <div class="contact-footer">
                <p style="margin-bottom: 5px; font-size: 14px; color: #444444;">Need help with the signing process?</p>
